...
PanelWindow {
  ...
  //   // This tells QML to re-evaluate this block whenever players are added/removed
  //   const count = Mpris.players.count; 
  //   if (count === 0) return null;

  //   // 1. Try to find a player that is actively playing
  ...
  //   // 2. Fallback to the first available player if none are currently playing
  ...
  Item {
          ...
          Repeater {
              ...
              Rectangle {
                  ...
                  color: (Hyprland.focusedWorkspace && Hyprland.focusedWorkspace.id === (index + 1)) ? root.theme.accentPrimary : "#45475a"
                    ...
                    //               color: modelData.focused ? root.theme.accentPrimary  ("#cba6f7" ):
                    //  modelData.urgent && urgentBlink ? root.theme.accentRed : root.theme.bgSurface
    ...
    Row {
      ...
      Rectangle {
        height: 24
        width: brightContent.width + volContent.width + 24
        radius: 12
        color: root.theme.bgSurface
